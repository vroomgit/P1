...
##  # Operating on second Number
##
##  l2 = np.array([])
##
##  y=int(y)
##  for i in range(0,100):
##    l2 = np.append(l2, int(y%10))
##    y=y/10
##    y=int(y)
##    if y==0:
##      break
...
##  l2new = np.flipud(l2)
##
##  l2new_list = l2new.tolist()
##  # l1new_list = l1new_list[::-1]
##
##  for i in range(0, len(l2new_list)):
##    l2new_list[i] = int(l2new_list[i])
##
##  length_2 = int(len(l2new_list)/2)
##
##  c_list = l2new_list[:length_2]
##  d_list = l2new_list[length_2:]
##

##  l1new = np.flipud(l1)
##
##  l1new_list = l1new.tolist()

##  x=int(x)

##  # Operating on First Number
##  print("Entered number 1 in Karatsub", x)
##  print("Entered number 2 in Karatsub", y)
##  l1 = []
##
##  # print("\nExecuting special algorithm\n")
##  for i in range(0,100):
##    temp = int()
##    temp = x%10
##    print("\n x % 10 =",temp)
